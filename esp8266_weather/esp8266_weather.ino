...
const char* hostweather = "api.seniverse.com";
const char* APIKEY = "xgducdrkt4uariz3";        //API KEY
...
void loop() {
  while (!client.connected()){
     if (!client.connect(hostweather, 80)){
         Serial.println("connection....");
         delay(500);
     }
  }
  if (sendRequest(hostweather, city, APIKEY) && skipResponseHeaders()) {
